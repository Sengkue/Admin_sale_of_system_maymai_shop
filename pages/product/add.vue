                  ...
                  <div class="justify-center text-center mt-5">
                    <div>
                      <v-avatar
                        ...
                        "
                      >
                        <v-img v-if="url1" :src="url1"></v-img>
                        <v-img v-else src="logo.png"></v-img>
                      </v-avatar>
                    </div>
                    <v-file-input
                    ...
                    ></v-file-input>
                    <!--------------------------- buttom banner -->
                    <v-btn class="mt-2" color="primary" small @click="upload1">
                      <v-icon>mdi-tray-arrow-up</v-icon>
                     Banner
                    </v-btn>
                  </div>
...
export default {
  ...
  methods: {
    ...
    onFileChange1(e) {
      if (e) {
        this.url1 = URL.createObjectURL(e)
      }
    },
    upload1() {
    ...
    async insert() {
      ...
      await this.$store.dispatch('product/insert', data)
