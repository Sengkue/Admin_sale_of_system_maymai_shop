          ...
          <v-container>
            <v-row>
              <v-col cols="6" class="my-0 py-0">
                <v-select v-model="owner_id" :items="getOwner" item-value="id" item-text="firstName" label="Owner" filled
                  dense prepend-inner-icon="mdi-account-heart" clearable clear-icon="mdi-close-circle-outline"
                  :disabled="employee_id !== ''" required></v-select>
              </v-col>
              <v-col cols="6" class="my-0 py-0">
                <v-select v-model="employee_id" :items="getEmployee" item-value="id" item-text="firstName"
                  label="Employee" filled dense prepend-inner-icon="mdi-account-group" clearable
                  clear-icon="mdi-close-circle-outline" :disabled="owner_id !== ''" required></v-select>
              </v-col>
